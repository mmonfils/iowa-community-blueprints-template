# Project Guardrails: Iowa Community Blueprints

> **Critical Repository Rule:** This document serves as the final, isolated gatekeeper for the Iowa Community Blueprints system. Before any investigative text, manual, analysis sheet, or homepage summary is pushed to the public website, it must be programmatically audited against this checklist. Failure on a single point requires an immediate halt to publishing.
...
* [ ] **Grassroots Autonomy Posture Check:** Verified that the project is framed contextually as an unfunded, autonomous initiative driven by private citizens acting in their individual capacities, completely unentangled from institutional grants or formal municipal affiliations.
...
* [ ] **Institutional Liability Insulation:** Verified that the document's framing shields individual contributors' legacy employers or organizations, completely avoiding language that attributes statements, endorsements, or institutional liabilities to them.